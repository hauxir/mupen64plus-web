...
int press_a(int c) {
    controller[c].buttons.A_BUTTON = 1;
}

int release_a(int c) {
    controller[c].buttons.A_BUTTON = 0;
}

int press_b(int c) {
    controller[c].buttons.B_BUTTON = 1;
}

int release_b(int c) {
    controller[c].buttons.B_BUTTON = 0;
}

int press_start(int c) {
    controller[c].buttons.START_BUTTON = 1;
}

int release_start(int c) {
    controller[c].buttons.START_BUTTON= 0;
}

int press_z(int c) {
    controller[c].buttons.Z_TRIG = 1;
}

int release_z(int c) {
    controller[c].buttons.Z_TRIG= 0;
}

int press_l(int c) {
    controller[c].buttons.L_TRIG= 1;
}

int release_l(int c) {
    controller[c].buttons.L_TRIG= 0;
}

int press_r(int c) {
    controller[c].buttons.R_TRIG= 1;
}

int release_r(int c) {
    controller[c].buttons.R_TRIG= 0;
}

int press_dleft(int c) {
    controller[c].buttons.L_DPAD= 1;
}

int release_dleft(int c) {
    controller[c].buttons.L_DPAD= 0;
}

int press_dright(int c) {
    controller[c].buttons.R_DPAD= 1;
}

int release_dright(int c) {
    controller[c].buttons.R_DPAD= 0;
}

int press_dup(int c) {
    controller[c].buttons.U_DPAD= 1;
}

int release_dup(int c) {
    controller[c].buttons.U_DPAD= 0;
}

int press_ddown(int c) {
    controller[c].buttons.D_DPAD= 1;
}

int release_ddown(int c) {
...
int set_y_axis(int c, int val) {
    controller[c].buttons.Y_AXIS = val;
}
